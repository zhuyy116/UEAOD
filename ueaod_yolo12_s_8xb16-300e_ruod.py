...
# -----data related-----
data_root = '../datasets/RUOD/'  # Root path of data
...
class_name = ('holothurian', 'echinus', 'scallop', 'starfish', 'fish',
              'corals', 'diver', 'cuttlefish', 'turtle', 'jellyfish')  # 数据集类别名称
...
# -----model related-----
residual = False   # "lx" is True
mlp_ratio = 2.0    # "lx" is 1.2
use_3k = False  # "mlx" is True
...
model = dict(
    ...
    bbox_head_guide=dict(
        type='PhysicsGuidedLossHead3',
        in_channels=256,
        widen_factor=widen_factor,
        alpha=0.6,
        beta=0.8,
...
val_evaluator = dict(
    ...
    metric_items=[
        'mAP', 'mAP_50', 'mAP_75', 'mAP_s', 'mAP_m', 'mAP_l', 'AR@100', 'AR@300', 'AR@1000', 'AR_s@1000',
        'AR_m@1000', 'AR_l@1000'
    ],
    metric='bbox')
...
randomness = dict(seed=42, diff_rank_seed=True, deterministic=True)